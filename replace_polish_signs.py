...
def convert_text(text, convert_type):
    ...
    if convert_type == 'PL2':
        ...
        print(f"Warning: Invalid conversion type '{convert_type}' passed to convert_text.")
...
def process_file(input_path, output_path, conversion_type):
    ...
    try:
        ...
        if conversion_type == 'PL2':
            ...
            print(f"Error: Invalid conversion_type '{conversion_type}' for process_file.")
            return False
...
if __name__ == "__main__":
    conversion_type_choice = input("Choose conversion type:\n(1) Remove_PL (PL to ASCII)\n(2) Restore_PL (ASCII to PL)\n>>> ")
